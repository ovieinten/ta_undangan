...
@section('content')
    ...
    <form action="{{ @$data['user'] ? route('backend.user_profile.update', ['id' => @$data['user']->id]) }}" enctype="multipart/form-data" method="post" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
      {{csrf_field()}}
