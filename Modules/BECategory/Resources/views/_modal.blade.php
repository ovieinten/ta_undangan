        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="form-group">
                    <label for="name" class="pull-left">Nama Kategori <span style="color: red">*</span></label>
                    <input required type="text" name="name" class="form-control" id="name" value="">
                </div>

                <div class="form-group">
                    <label for="desc" class="pull-left">Deskripsi Kategori</label>
                    <textarea required class="form-control" name="desc" id="desc" cols="30" rows="5"></textarea>
                </div>
            </div>
                ...
                <div class="modal-body">
                    ...
                    <table id="" class="table table-bordered sticky-table-header fixed-solution">
                        ...
                        <tr>
                            ...
                            <td class=""><span id="d_desc"></span></td>
                        </tr>
                        </tbody>
                    </table>
                    </div>
