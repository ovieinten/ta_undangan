                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            <label>Nama</label>
                            <input class="form-control" required type="text" id="name" name="name" value="{{ @$data['product']->name }}" readonly="">
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="form-group">
                            <label>Description</label>
                            <textarea required id="desc" name="desc" style="width: 100%;" readonly>{{ @$data['product']->desc }}</textarea>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <select required name="category" class="select-form-advance js-select2 form-control" readonly="">
                                <option readonly selected value>Pilih Kategori</option>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <label>Price</label>
                            <input class="form-control" required type="text" id="" name="price" value="{{ @$data['product']->price }}" readonly="">
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="form-group">
                            <label>Note</label>
                            <textarea required id="note" name="note" style="width: 100%;" readonly>{{ @$data['product']->note }}</textarea>
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="form-group">
